...
if uploaded_file is not None:     
    ...
    g = nx.from_pandas_edgelist(data, source = "SOURCE", target = "DESTINATION", edge_attr=['DISTANCE_KM','DURATION_MIN']) #Use the Graph API to create an empty network graph object
